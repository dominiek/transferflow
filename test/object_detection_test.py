...
class ObjectDetectionTrainTest(unittest.TestCase):
    ...
    def test_train_faces(self):
        ...
        trainer.train(train_bounding_boxes, test_bounding_boxes, test_dir + '/fixtures/tmp/faces_test.chkpt', {'num_steps': 50})

    def test_run_faces(self):
        runner = Runner(test_dir + '/fixtures/tmp/faces_test.chkpt-50')
